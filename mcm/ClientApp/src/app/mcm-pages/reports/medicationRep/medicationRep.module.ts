...
import { MedicationRepComponent } from "./medicationRep.component";
...
@NgModule({
  ...
  declarations: [MedicationRepComponent],
  exports: [MedicationRepComponent]
})

export class MedicationRepModule {
