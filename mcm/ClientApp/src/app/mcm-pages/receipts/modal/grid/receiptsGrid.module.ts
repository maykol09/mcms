...
import { ReceiptsGridComponent } from "./receiptsGrid.component";
...
@NgModule({
  ...
  declarations: [ReceiptsGridComponent],
  exports: [ReceiptsGridComponent],
  bootstrap: [ReceiptsGridComponent]
})

export class ReceiptsGridModule {
